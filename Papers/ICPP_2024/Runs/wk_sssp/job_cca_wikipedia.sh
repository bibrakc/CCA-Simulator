...
MEMORY_CC[64]=3610380 #1388608
VICINITY[64]=7
MAX_EDGES[64]=70

MEMORY_CC[128]=1103190 #424304
VICINITY[128]=8
#VICINITY[128]=128
MAX_EDGES[128]=85
...
for CHIP_DIM in "${CHIP_DIM_VALUES[@]}"; do
	...
	CUTOFF=${RHIZOME_CUTOFF[$RHIZOME]}
            srun -N 1 -n 1 -c ${threads} ${exe} -r ${repository} -d ${dataset} \
                 ...
                 -chip_dim ${CHIP_DIM} \
                 -memory_cc ${memory} -rhizomes ${RHIZOME} -cutoff ${CUTOFF} -script run_sssp_wikipedia.zsh
    done
done
